...
@stop
@section('header')
    Editar Pregunta Frecuente <small>Completa el formulario para editar una pregunta frecuente</small>
@endsection
@section('content')
    <div class="col-md-12">
        <!-- begin panel -->
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Editar Pregunta Frecuente</h4>
            </div>
            <div class="panel-body">
                <form id="form" class="form-horizontal" data-parsley-validate enctype="multipart/form-data" action="{{ route('questions.update', $question->id) }}" method="POST">
